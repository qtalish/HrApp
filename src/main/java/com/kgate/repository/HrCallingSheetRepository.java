...
//	List<HrCallingSheet> findByUpdatedDateAndEmpCode(Date date, String empCode);
	...
	@Query(value="SELECT candidateName from HrCallingSheet  where empCode=:empCode and updateDate=:updateDate ", nativeQuery = true)
	public List<String> getCandidate(@Param("empCode") String empCode,@Param("updateDate") Date updateDate);
}
