...
public class AttendanceImport {
	...
	public String toString() {
		return "AttendanceImport [id=" + id + ", empCode=" + empCode + ", firstName=" + firstName + ", lastName="
				+ lastName + ", month=" + month + ", year=" + year + ", d1=" + d1 + ", d2=" + d2 + ", d3=" + d3
				+ ", d4=" + d4 + ", d5=" + d5 + ", d6=" + d6 + ", d7=" + d7 + ", d8=" + d8 + ", d9=" + d9 + ", d10="
