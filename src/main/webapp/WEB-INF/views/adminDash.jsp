		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link"
					href="/HrApp/viewEmployees">View All Employees <!-- <span class="sr-only">(current)</span> --></a>
				</li>
				<li class="nav-item"><a class="nav-link" href="/HrApp/register">Add
						Employee</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/HrApp/attendance">Attendence</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/HrApp/messageEmployee">Message</a>
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="/HrApp/register">Add
										Employee</a> <a class="dropdown-item" href="/HrApp/viewEmployees">View
										All Employees </a>
								</div></li>
						</ul>
					...
					</div> <footer class="page-footer font-small special-color-dark ">
						<div class="container"></div>
						<div class="footer-copyright text-center py-5">
							© 2019 Copyright: <a href="http://www.kgate.in/">K-Gate</a>
						</div>
					</footer>
</body>
</html>