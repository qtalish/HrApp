...
<table class="table">
		<form:form action="submitCallingSheet" method="post"
			...
			<tr>
				<td>Date</td>
				<td><form:input type="date" path="date" class="form-control" readonly="true"/></td>
			</tr>
			<tr>
				<td>Candidate Name</td>
				<td><form:input path="candidateName" class="form-control" /></td>
			</tr>
			<tr>
				<td>Skills</td>
				<td><form:input path="skills" class="form-control" /></td>
			</tr>
			<tr>
				<td>Mobile Number</td>
				<td><form:input path="mob" class="form-control" /></td>
			</tr>
			<tr>
				<td>Email</td>
			...
			<tr>
				...
				<td><form:input path="totalExp" class="form-control" /></td>
			</tr>
			<tr>
				<td>Status</td>
				<td><form:select path="status" class="form-control"><form:options items="${status}"/></form:select> </td>
			</tr>
			<tr>
				<td>Remark</td>
				<td><form:input path="remark" class="form-control" /></td>
			</tr>
			<tr>
				<td></td><td><button class="btn btn-primary">Submit</button></td>
