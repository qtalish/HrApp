...
<body>
	...
	<p align="center">
		<a href="register?mylocale=en">English</a> | <a
			href="register?mylocale=de"> मराठी </a> | <a
			href="register?mylocale=gj">ગુજરાતી</a>|<a
			href="register?mylocale=urdu">اردو</a>
	</p>
		...
		<table class="table">
			...
			<form:form action="save" method="post" modelAttribute="user">
				...
				<tr>
					...
					<td><form:input id="fname" path="fname" class="form-control"
							onblur="first()" /></td>
					<td><p style="color: red" id="fn"></p></td>
				</tr>
				<tr>
					<td><spring:message code="user.mname" /></td>
					<td><form:input id="mname" path="mname" class="form-control"
							onblur="middle()" /></td>
					<td><p style="color: red" id="mn"></p></td>
				</tr>

				<tr>
					<td><spring:message code="user.lname" /></td>
					<td><form:input id="laname" path="lname" class="form-control"
							onblur="lastName()" /></td>
					<td><p style="color: red" id="lastName"></p></td>
				</tr>
				<tr>
					<td><spring:message code="user.email" /></td>
					<td><form:input id="email" path="email" class="form-control"
							onblur="emailId()" /></td>
					<td><p style="color: red" id="em"></p></td>
				</tr>
				<tr>

					<td><spring:message code="user.dob" /></td>
					<td><form:input path="dob" type="date" class="form-control"
							id="datepicker" /></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><form:input path="bloodGroup" id="bloodGroup"
							class="form-control" onblur="bgValidate()" /></td>
					<td><p style="color: red" id="bg"></td>
				</tr>
				<tr>
					<td><spring:message code="user.aadhar" /></td>
					<td><form:input path="aadhar" id="aadhar" class="form-control"
							onblur="aadharValidate()" /></td>
					<td><p style="color: red" id="aa"></p></td>
				</tr>
				<tr>
					<td><spring:message code="user.pan" /></td>
					<td><form:input path="pan" id="pan" class="form-control"
							onblur="validatePAN()" /></td>
					<td><p style="color: red" id="pa"></p></td>
				</tr>
				...
				<tr>
					...
					<td><form:input path="joiningDate" type="date"
							class="form-control" id="joiningDate" /></td>
					<td><p style="color: red" id="jd"></p></td>
				</tr>
				<tr>
					<td><spring:message code="user.address" /></td>
					<td><form:input id="address" class="form-control"
							path="address" /></td>
					<td><p style="color: red" id="ad"></p></td>
				</tr>

				<tr>
					<td><spring:message code="user.mob" /></td>
					<td><form:input path="mob" id="mob" class="form-control"
							onblur="mobile()" /></td>
					<td><p style="color: red" id="mo"></p></td>
				</tr>

				<tr>
					<td><spring:message code="user.salary" /></td>
					<td><form:input path="salary" id="salary" class="form-control"
							onblur="sal()"/></td>
					<td><p style="color: red" id="sa"></p></td>
				</tr>
				<%-- <tr>
				...
				<tr>
					...
					<td><form:select path="userType" class="dropdown-header"
							required="required">
